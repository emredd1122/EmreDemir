...
<section>
	...
	<div class="analizler">
		...
		<li><a class="aktif" href="iade.php">İade Analizleri</a></li><br>
...
var myChart2 = new Chart(ctx, {
    ...
    options: {
    	title: {
            display: true,
            text: 'Klasik Ayakkabı İade Miktarı',
        }
...
var myChart3 = new Chart(ctx, {
    ...
    options: {
    	title: {
            display: true,
            text: 'Rugan Ayakkabı İade Miktarı',
        }
...
var myChart4 = new Chart(ctx, {
    ...
    options: {
    	title: {
            display: true,
            text: 'Süet Ayakkabı İade Miktarı',
        }
...
var myChart5 = new Chart(ctx, {
    ...
    options: {
    	title: {
            display: true,
            text: 'Nubuk Ayakkabı İade Miktarı',
        }
